...
fname1 = '/Volumes/Schultz_group_data/Crazy Eights/Ann/GCaMP6 imaging/2018.03.05/2P/20180305_17_51_12_2P/20180305_17_51_12_2P_XYT_ch_3.tif'; %green channel
fname2 = '/Volumes/Schultz_group_data/Crazy Eights/Ann/GCaMP6 imaging/2018.03.05/2P/20180305_17_51_12_2P/20180305_17_51_12_2P_XYT_ch_4.tif'; %red channel
...
green_channel=zeros(512,512,num_images2g,'single');
red_channel=zeros(512,512,num_images2r,'single');
% Load the images and save the values in the array
%{
for k = 1:num_images1g
    [green_channel_chunk(:,:,k), map_green] = imread(fname1, k, 'Info', info1);
    [red_channel_chunk(:,:,k), map_red] = imread(fname2, k, 'Info', info2);
end
%}
for k = 1:num_images2g
...
clearvars -except green_channel red_channel; %green_channel_chunk red_channel_chunk;
...
while (retuned_masks_num > exp_ROIs)
    ...
    %}
    phi = initialise(initial_image, radius, retuned_alpha, retuned_opt);
...
%seg_opt.cell_to_monitor     = 20; % any random number

if retune_lambda  
	[lambda, phi]         = tune_lambda2(phi_0, green_channel, red_channel, radius,...
                                 seg_opt, corrIm_red, meanIm_red);
