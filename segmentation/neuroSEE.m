...
msg1 = ['What is the filename of the calcium imaging data ',...
           'that you want to analyse? '];

filename1 = input(msg1, 's');
...
%
msg2 = ['What is the filename of the composite image (red and ',...
           'green channels) that you want to use as a summary image? '];

filename2 = input(msg2, 's');
...
msg3 = ['What is the expected radius of each cell (in pixels)? '];

radius = input(msg3); % expected cell radius in pixels; usually set to 10
...
msg3 = ['What is the approximate maximum number of cells that ' ...
        'we expect to see in this frame? '];
